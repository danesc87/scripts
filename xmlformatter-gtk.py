...
class XMLParser(object):
    ...
    def get_file(self):
        try:
            ...
            os.system('zenity --info --title="Error" --text="You must specify a file name!"')
    ...
    def parse_xml(self):
        if os.path.isfile(self.file_name) and os.access(self.file_name, os.R_OK):
            ...
            try:
                ...
                os.system('zenity --info --title="Error Parsing File" --text="XML file %s"' % str(bad_xml))
            ...
            os.system('zenity --info --title="Error" --text="File is missing or is not readable!"')
